...
int main() {
    ...
    if (choice == 'n') {
		...
		printf("Contact our internal hardware expert Miss. Thakral.\n");
		printf("Contact info:\nPhone no - 1234561\nEmail - thakral@gmail.com\n");
		cost = 500;
		break;
		case 2:
		printf("Your system is very slow, or virus infected.\n");
		printf("Contact our internal software expert Mr. Khan.\n");
		...
		printf("Contact our internal hardware expert Mr. Kumar.\n");
